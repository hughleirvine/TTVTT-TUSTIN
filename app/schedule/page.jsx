        ...
        {futureFullSchedule && futureFullSchedule.length > 1 && (
            <>
                ...
                <ul>
                  ...
                  <br/><li><strong>(3) Thay Thế (Standby) cho Mình Thánh</strong> - Thay thế (Standby) cho Mình Thánh. Cần một thành viên đảm nhận vị trí (1), nếu không đủ 6 người phục vụ. Khi được phân công vào vị trí “standby”, xin quý anh chị lưu ý rằng đây là vị trí dự phòng, chưa phục vụ chính thức. Chỉ khi nhóm trưởng liên lạc (qua tin nhắn hoặc điện thoại) ít nhất một ngày trước Thánh lễ thì người standby mới được gọi thay thế cho người vắng mặt. Khi nhận thông báo, nhóm trưởng sẽ nêu rõ vị trí cụ thể cần thay thế.</li>
                  ...
                  <br/><li><h2>Chú Ý:</h2> Theo đề nghị của Thầy Đông, xin quý chị khi mặc đầm hở vai thì nên khoác jacket vào để phục vụ.</li>
                </ul>
            </>
        )}
      </div>
